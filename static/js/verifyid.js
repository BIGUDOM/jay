const MobileVerifyIdfrom = document.getElementById("VerifyIdfrom");
const LapVerifyIdfrom = document.getElementById("lapVerifyIdfrom");
...
MobileVerifyIdfrom.addEventListener("submit", async function (e) {
    e.preventDefault();

    const loginbtn = document.getElementById("mobilebtn");

    const d_data = new FormData(MobileVerifyIdfrom)
 


    setLoading(loginbtn);
    try {
        const response = await fetch("/verifyid", {
            method: "POST",
            body: d_data
        });
...
LapVerifyIdfrom.addEventListener("submit", async function (e) {
    e.preventDefault();

    const loginbtn = document.getElementById("lapbtn");

    const d_data = new FormData(LapVerifyIdfrom)
