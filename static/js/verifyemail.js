const MobileVerifyEmailfrom = document.getElementById("VerifyEmailForm");
const LapVerifyEmailfrom = document.getElementById("LapVerifyEmailForm");
...
MobileVerifyEmailfrom.addEventListener("submit", async function (e) {
    e.preventDefault();

    const loginbtn = document.getElementById("mobilebtn");

    const d_data = new FormData(LapVerifyEmailfrom)
    ...
    try {
        ...
        if (data.status === "success") {
            showSuccessModal("Thank you for verifying your account. You can continue using your account without restrictions.", "/", 200)
...
LapVerifyEmailfrom.addEventListener("submit", async function (e) {
    e.preventDefault();
